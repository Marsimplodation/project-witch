...
GLFWwindow* VkRenderer::create_window_glfw(const char* window_name, bool resize) {
    glfwInit();
...
void VkRenderer::destroy_window_glfw(GLFWwindow* window) {
    glfwDestroyWindow(window);
    glfwTerminate();
}

VkSurfaceKHR VkRenderer::create_surface_glfw(VkInstance instance, GLFWwindow* window, VkAllocationCallbacks* allocator) {
...
int VkRenderer::device_initialization() {
